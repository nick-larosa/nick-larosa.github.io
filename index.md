...
This bar and pie chart illustrate all airplane crashes recorded and investigated by the NTSB from 2010 to the start of 2020. Data is sourced from the [NTSB Aviation Accident Database & Synopses](https://www.ntsb.gov/_layouts/ntsb.aviation/index.aspx).
...
<br><br>
These maps provide a visualization of NTSB investigated aircraft crashes. The first indicates the type of aircraft using the color and the severity and number of fatalities using the size of the point. The second indicates the federal classification of aviation activity using the color. Data is sourced from the [NTSB Aviation Accident Database & Synopses](https://www.ntsb.gov/_layouts/ntsb.aviation/index.aspx).
